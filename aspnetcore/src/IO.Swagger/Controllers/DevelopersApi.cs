...
{ 
    ...
    { 
        ...
        /// <param name="sortOrder">pass an optional search string for looking up inventory</param>
        ...
        public virtual IActionResult SearchInventory([FromQuery]string searchString, [FromQuery]string sortOrder, [FromQuery]int? skip, [FromQuery][Range(0, 50)]int? limit)
        { 
        ...
        /// <response code="400">bad input parameter</response>
        [HttpGet]
        [Route("/nikitanewmsk/simple/1.0.0/inventory/naa")]
        [ValidateModelState]
        [SwaggerOperation("SearchInventoryNaa")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<InventoryItem>), description: "search results matching criteria")]
        public virtual IActionResult SearchInventoryNaa([FromQuery]string searchString, [FromQuery]int? skip, [FromQuery][Range(0, 50)]int? limit)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(List<InventoryItem>));
